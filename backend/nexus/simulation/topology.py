...
SERVICES: dict[str, ServiceSpec] = {
    "api-gateway": ServiceSpec(
        ...
        replicas=16, rps_per_replica=180, base_service_time_ms=4.0,
        base_error_pct=0.08, base_mem_pct=41, timeout_ms=2500,
        slo_p95_ms=600, slo_error_pct=1.5, retry_policy=0.0,
    ...
    "auth-service": ServiceSpec(
        ...
        replicas=16, rps_per_replica=150, base_service_time_ms=11.0,
        base_error_pct=0.05, base_mem_pct=38, timeout_ms=800,
        slo_p95_ms=180, slo_error_pct=0.5, retry_policy=0.7,
    ...
    "payment-service": ServiceSpec(
        ...
        replicas=8, rps_per_replica=70, base_service_time_ms=26.0,
        base_error_pct=0.12, base_mem_pct=46, timeout_ms=4000,
        slo_p95_ms=900, slo_error_pct=0.5, retry_policy=0.4,
