...
const LAYERS = [
  ...
  ["4 · Root cause", "REAL",
   "Thirty class-agnostic incident features (metric z-peaks, Mann-Kendall memory trend, error/latency dominance, saturation index, log-pattern rates, deploy alignment, SLO ratios) feed a multinomial logistic regression trained on seeded episodes with GroupKFold CV. Per-feature coefficient × standardized-value contributions are surfaced as evidence."],
  ["5 · Retrieval", "REAL",
   "BM25 fused with TF-IDF + Truncated SVD via reciprocal rank fusion over a 14-document runbook corpus, with a service-tag boost and one-chunk-per-document dedup. Retrieved documents carry an executable action manifest."],
  ["6 · Agent", "REAL",
